...
**Scope:** [`memory/cognitive_journal.py`](../../memory/cognitive_journal.py)

---

## 1. Append-Only Event Sourcing

`CognitiveJournal` ([`memory/cognitive_journal.py`](../../memory/cognitive_journal.py#L20-L240)) provides append-only event-sourced persistence:
