...
**Scope:** [`core/belief_detector.py`](file:///home/nemo/_mrag_composite_test/core/belief_detector.py)

---

## 1. Post-Pulse Realization Scanning

`BeliefDetector` ([`core/belief_detector.py`](file:///home/nemo/_mrag_composite_test/core/belief_detector.py#L40-L380)) scans pulse monologue output for belief-forming realizations:
